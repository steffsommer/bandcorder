...
// in bandcorder/test/screens/connect_screen_test.dart.
...
import 'package:bandcorder/services/connection_cache_service.dart' as _i5;
import 'package:bandcorder/services/connection_config.dart' as _i6;
...
/// A class which mocks [ConnectionCacheService].
///
/// See the documentation for Mockito's code generation for more information.
class MockConnectionCacheService extends _i1.Mock
    implements _i5.ConnectionCacheService {
  MockConnectionCacheService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Future<void> cacheHost(String? address) =>
      (super.noSuchMethod(
            Invocation.method(#cacheHost, [address]),
            returnValue: _i3.Future<void>.value(),
            returnValueForMissingStub: _i3.Future<void>.value(),
          )
          as _i3.Future<void>);
  ...
  @override
  _i3.Future<String?> queryHost() =>
      (super.noSuchMethod(
            Invocation.method(#queryHost, []),
...
///
/// See the documentation for Mockito's code generation for more information.
class MockConnectionConfig extends _i1.Mock implements _i6.ConnectionConfig {
